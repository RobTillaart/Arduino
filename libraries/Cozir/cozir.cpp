...
const uint8_t CZR_AHHI     = 0x00;       //  reserved
const uint8_t CZR_ANLO     = 0x01;       //  reserved
const uint8_t CZR_ANSOURCE = 0x02;       //  reserved
const uint8_t CZR_ACINITHI = 0x03;       //  87
const uint8_t CZR_ACINITLO = 0x04;       //  192
const uint8_t CZR_ACHI     = 0x05;       //  94
const uint8_t CZR_ACLO     = 0x06;       //  128
const uint8_t CZR_ACONOFF  = 0x07;       //  0
const uint8_t CZR_ACPPMHI  = 0x08;       //  1
const uint8_t CZR_ACPPMLO  = 0x09;       //  194
const uint8_t CZR_AMBHI    = 0x0A;       //  1
const uint8_t CZR_AMBLO    = 0x0B;       //  194
const uint8_t CZR_BCHI     = 0x0C;       //  0
const uint8_t CZR_BCLO     = 0x0D;       //  8
