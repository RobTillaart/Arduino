...
//  AUTHOR: Rob Tillaart
//    DATE: 2026-03-30
// PURPOSE: unit tests for the HX712 library (24 bit ADC for load cells)
...
unittest_setup()
{
  fprintf(stderr, "HX712_LIB_VERSION: %s\n", (char *) HX712_LIB_VERSION);
}
...
{
  assertEqual(0x00, HX712_AVERAGE_MODE);
  assertEqual(0x01, HX712_MEDIAN_MODE);
  assertEqual(0x02, HX712_MEDAVG_MODE);
  assertEqual(0x03, HX712_RUNAVG_MODE);
  assertEqual(0x04, HX712_RAW_MODE);

  assertEqual(128,  HX712_GAIN_128);
  assertEqual(256,   HX712_GAIN_256);
}
