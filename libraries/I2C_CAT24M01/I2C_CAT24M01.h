...
#define I2C_CAT24M01_LIB_VERSION    (F("0.1.0"))


#define I2C_DEVICESIZE_CAT24M01     131072
#define I2C_PAGESIZE_CAT24M01       256
...
public:
  ...
  I2C_CAT24M01(uint8_t deviceAddress, TwoWire *wire = &Wire);
...
private:
  ...
  uint32_t _deviceSize = I2C_DEVICESIZE_CAT24M01;
  uint16_t _pageSize   = I2C_PAGESIZE_CAT24M01;
