...
Since 0.4.2 the library provides **getClicks()** and a **setStepsPerClick()**
...
The example **rotaryDecoder_demo_interrupt.ino** shows a possible solution 
...
- change bool to **int update()** the number of changed rotary encoders?
  - idem **int updateSingle()**
  - ==> doesn't tell that much extra.
